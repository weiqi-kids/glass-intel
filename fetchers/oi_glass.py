...
class OiGlassFetcher(CompanyFetcher):
    """O-I Glass 爬蟲"""

    company_id = "oi_glass"
    company_name = "O-I Glass"
    news_url = "https://www.o-iglass.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.o-iglass.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from O-I Glass")
        return documents
