...
class TataChemicalsFetcher(CompanyFetcher):
    """Tata Chemicals 爬蟲"""

    company_id = "tata_chemicals"
    company_name = "Tata Chemicals"
    news_url = "https://www.tatachemicals.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tatachemicals.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Tata Chemicals")
        return documents
