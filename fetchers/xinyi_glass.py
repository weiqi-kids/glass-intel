...
class XinyiGlassFetcher(CompanyFetcher):
    """Xinyi Glass 爬蟲"""

    company_id = "xinyi_glass"
    company_name = "Xinyi Glass"
    news_url = "https://www.xinyiglass.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.xinyiglass.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Xinyi Glass")
        return documents
