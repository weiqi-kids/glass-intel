...
class LongiFetcher(CompanyFetcher):
    ...
    company_id = "longi"
    company_name = "LONGi Green"
    news_url = "https://www.longigreen.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.longigreen.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from LONGi Green")
        return documents
