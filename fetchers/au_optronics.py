...
class AuOptronicsFetcher(CompanyFetcher):
    """AU Optronics 爬蟲"""

    company_id = "au_optronics"
    company_name = "AU Optronics"
    news_url = "https://www.auoptronics.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.auoptronics.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from AU Optronics")
        return documents
