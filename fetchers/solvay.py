...
class SolvayFetcher(CompanyFetcher):
    """Solvay 爬蟲"""

    company_id = "solvay"
    company_name = "Solvay"
    news_url = "https://www.solvay.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Solvay")
        return documents
