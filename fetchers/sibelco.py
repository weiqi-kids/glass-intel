...
class SibelcoFetcher(CompanyFetcher):
    """SCR-Sibelco 爬蟲"""

    company_id = "sibelco"
    company_name = "SCR-Sibelco"
    news_url = "https://www.scr-sibelco.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.scr-sibelco.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from SCR-Sibelco")
        return documents
