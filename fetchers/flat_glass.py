...
class FlatGlassFetcher(CompanyFetcher):
    """Flat Glass Group 爬蟲"""

    company_id = "flat_glass"
    company_name = "Flat Glass Group"
    news_url = "https://www.flatglassgroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.flatglassgroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Flat Glass Group")
        return documents
