...
class TaiwanGlassFetcher(CompanyFetcher):
    ...
    company_name = "Taiwan Glass"
    news_url = "https://www.taiwanglass.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.taiwanglass.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Taiwan Glass")
        return documents
