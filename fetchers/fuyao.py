...
class FuyaoFetcher(CompanyFetcher):
    ...
    company_id = "fuyao"
    company_name = "Fuyao Glass"
    news_url = "https://www.fuyaoglass.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.fuyaoglass.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Fuyao Glass")
        return documents
