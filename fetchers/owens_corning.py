...
class OwensCorningFetcher(CompanyFetcher):
    """Owens Corning 爬蟲"""

    company_id = "owens_corning"
    company_name = "Owens Corning"
    news_url = "https://www.owenscorning.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.owenscorning.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Owens Corning")
        return documents
