...
class NsgFetcher(CompanyFetcher):
    """Nippon Sheet Glass 爬蟲"""

    company_id = "nsg"
    company_name = "Nippon Sheet Glass"
    news_url = "https://www.nipponsheetglass.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.nipponsheetglass.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Nippon Sheet Glass")
        return documents
